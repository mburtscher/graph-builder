...
use GraphQL\Examples\BlogNg\Type\QueryType;
use \GraphQL\Schema;
use \GraphQL\GraphQL;
use \GraphQL\Type\Definition\Config;
use \GraphQL\Error\FormattedError;

AnnotationRegistry::registerFile(__DIR__ . "/../../src/Annotations/Enum.php");
AnnotationRegistry::registerFile(__DIR__ . "/../../src/Annotations/Id.php");
AnnotationRegistry::registerFile(__DIR__ . "/../../src/Annotations/Resolve.php");
